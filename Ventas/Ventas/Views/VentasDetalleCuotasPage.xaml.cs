...
namespace Ventas.Views
{
    ...
    public partial class VentasDetalleCuotasPage : ContentPage
    {
        ...
        public VentasDetalleCuotasPage()
        {
            InitializeComponent();
        }
        ...
        private async Task<bool> Validacion()
        {
            ...
            if ( General.NE( General.FechaISO(cFechaCuota) ) <= General.NE( General.FechaISO(txtFecha.Text)))
            {
