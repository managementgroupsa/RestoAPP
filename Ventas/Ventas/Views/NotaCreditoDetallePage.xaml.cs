...
namespace Ventas.Views
{
    ...
    public partial class NotaCreditoDetallePage : ContentPage
    {
        ...
        string cNummov = Application.Current.Properties["Ncm_cNumMov"] as string;
        ...
        public NotaCreditoDetallePage()
        {
            ...
            dtDetalle = Propiedades.CreateEntityToDataTable(typeof(VTD_NOTACREDITO_Entity), Title);
            ...
            if (cOpcion == Opciones.Nuevo)
            {
                ...
                txtTipoNotaCredito.Text = "01 - ANULACIÓN DE LA OPERACIÓN";
                txtSeriedoc.Text = "F001";

                Application.Current.Properties["Ncm_cTipoDoc"] = General.PrimerValor(txtTipoNotaCredito.Text);
                Application.Current.Properties["Ncm_cSerieDoc"] = General.PrimerValor(txtSeriedoc.Text);
        ...
        private void RedimencionarCombos()
         {
            Application.Current.Properties["AltoVentana"] = (DeviceDisplay.MainDisplayInfo.Height / DeviceDisplay.MainDisplayInfo.Density) - 80;
            tdbcTipoNotaCredito.PickerHeight = General.NE(Application.Current.Properties["AltoVentana"]);
            tdbcSerie.PickerHeight = General.NE(Application.Current.Properties["AltoVentana"]);
         }

        private List<string> LlenaTipoNC()
        {
            List<string> oLista = new List<string>();

           TABLA_Entity oEntidad = new TABLA_Entity();

            oEntidad.Accion = "TIPO_NC_APP";
            oEntidad.Emp_cCodigo = cEmpresa;
            oEntidad.Tab_cTabla = "800";
            oEntidad.Tab_cEstado = "A";
           ...
           string result = ProcedimientosAPI.GetPostBuscarTablas(oEntidad);
            ...
            {
                oLista.Add(message.Tab_cValor + " - " + message.Tab_cDescripCampo);
            }
        ...
        private List<string> LlenaSerie()
        {
            ...
            oEntidad.Emp_cCodigo = cEmpresa;
            oEntidad.Doc_cTipoDoc = Application.Current.Properties["Ncm_cTipoDoc"] as string;
        ...
        private string LlenaNumero()
        {
            ...
            try
            {
                ...
                oEntidad.Emp_cCodigo = cEmpresa;
                oEntidad.Doc_cTipoDoc = Application.Current.Properties["Ncm_cTipoDoc"] as string;
                oEntidad.Doc_cSerie = Application.Current.Properties["Ncm_cSerieDoc"] as string;
        ...
        {
            Propiedades.SoloLecturaEntry(txtTipoNotaCredito, true);
            ...
            //btnEliminarFilaCuo.IsVisible = !bEstado;
             ...
             btnTipoNotaCredito.IsVisible = !bEstado;
        ...
        private void tdbcTipoNotaCredito_OkButtonClicked(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
        {
            txtTipoNotaCredito.Text = e.NewValue.ToString();
            Application.Current.Properties["Ncm_cTipoNC"] = General.PrimerValor(e.NewValue.ToString());

        }

        private void btnTipoNotaCredito_Clicked(object sender, EventArgs e)
        {
            RedimencionarCombos();
            tdbcTipoNotaCredito.ItemsSource = LlenaTipoNC();
            tdbcTipoNotaCredito.IsOpen = true;
        ...
        private void tdbcSerie_OkButtonClicked(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
        {
            ...
            Application.Current.Properties["Ncm_cSerieDoc"] = General.PrimerValor(e.NewValue.ToString());
        ...
        private async Task<bool> ValidaCabecera()
        {
            ...
            if (string.IsNullOrEmpty(txtTipoNotaCredito.Text))
            {
            ...
            if (string.IsNullOrEmpty(txtDireccion.Text) && (General.PrimerValor(txtTipoNotaCredito.Text) == "01"))
            {
        ...
        {
            if (!String.IsNullOrEmpty(txtNumeroDocId.Text) && txtNumeroDocId.Text == "0" && General.PrimerValor(txtTipoNotaCredito.Text) != "01")
            {
                ClientePorDefectoBoleta();
            }
        }
        ...
        private void tabNotaCredito_SelectionChanging(object sender, Syncfusion.XForms.TabView.SelectionChangingEventArgs e)
        {
        ...
        private void dtpFechaDocumento_OkButtonClicked(object sender, Syncfusion.XForms.Pickers.DateChangedEventArgs e)
        {

        }

        private void btnFechaDocumento_Clicked(object sender, EventArgs e)
        {
        ...
        private void tdbcSerie_OkButtonClicked_1(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
        {

        }

        private void btnSeriedoc_Clicked_1(object sender, EventArgs e)
        {

        }

        private void tdbcTipoDocFt_OkButtonClicked(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
        {

        }

        private void btnTipoDocFt_Clicked(object sender, EventArgs e)
        {

        }

        private void tdbcSerieFt_OkButtonClicked(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
        {

        }

        private void btnSeriedocFt_Clicked(object sender, EventArgs e)
        {

        }

        private void btnBuscarFt_Clicked(object sender, EventArgs e)
        {
