...
namespace Ventas.Views
{
    ...
    public partial class ClasePage : ContentPage
    {
        ...
        private async void btnNuevo_Clicked(object sender, EventArgs e)
        {
            ...
            await Shell.Current.GoToAsync($"{nameof(ClasedetallePage)}");
        }
        ...
        private async void Eliminar()
        {
            try
            {
                ...
                string resultPost = ProcedimientosAPI.GetPostEliminarClase(oEntidad);
        ...
        private void filterText_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                view.RowFilter = "Cla_cClase like '%" + e.NewTextValue + "%' or Cla_cDescripLarga like '%" + e.NewTextValue + "%' ";
            }
        }
        ...
        {
            var oEntidad = new ClaseViewModel();
